                      ...
                      <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                        ...
                        <div className="z-10 sm:col-span-6">
                          <h3 className="font-medium leading-snug text-violet-12">
                            <div>
                              <a className="inline-flex items-baseline font-medium leading-tight text-violet-12 hover:text-mint focus-visible:text-mint  group/link text-base" href="https://www.nagios.com/" target="_blank" rel="noreferrer noopener" aria-label="Full Stack Developer, Accessibility at Nagios (opens in a new tab)">
                          ...
                          <ul className="mt-2 flex flex-wrap" aria-label="Technologies used">
                            <li className="mr-1.5 mt-2"><div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-mint ">JavaScript</div></li>
                            <li className="mr-1.5 mt-2"><div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-mint ">PHP</div></li>
                            <li className="mr-1.5 mt-2"><div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-mint ">React</div></li>
                            <li className="mr-1.5 mt-2"><div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-mint ">TailWind CSS</div></li>
                          </ul>
                        </div>
                      </div>
                    </li> */}
